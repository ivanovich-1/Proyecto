...
public class Formato {
	...
	public static final String PATRON_CONTRASEÑA2 = "(?=^.{8,}$)((?=.*\\d)|(?=.*\\W+))(?![.\\n])(?=.*[A-Z])(?=.*[a-z]).*$";
	public static final String PATRON_CONTRASEÑA3 = "(?=.*\\d)(?=.*[A-ZÑ])(?=.*[a-zñ])(?=.*[#$*-+&!?%]).{8,}";
	public static final String PATRON_CONTRASEÑA4 = "^(?=\\w*\\d)(?=\\w*[A-Z])(?=\\w*[a-z])\\S{6,16}$";
	public static final String PATRON_CONTRASEÑA5 ="^(?=.*\\d)(?=.*[\\u0021-\\u002b\\u003c-\\u0040])(?=.*[A-Z])(?=.*[a-z]).{6,16}$";
	public static final String PATRON_CONTRASEÑA6 = "((?=.{0,}[A-ZÑ])(?=.{0,}[a-zñ])(?=.{1,}\\d)(?=.{1,}[¡!$€%&@/\\\\()=?¿*[];,:._-+<>])).{6,16}";
	public static final String PATRON_CONTRASEÑA7 = "^(?=[^\\d_].*?\\d)\\w(\\w|[!@#$%]){7,20}";
	...
	public static final String PATRON_NUMERO_POSTAL = "[\\d]+[\\A-Z]?";

	public static final String PATRON_NOMBRE_PERSONA = "^[A-ZÑÁÉÍÓÚ][A-ZÑÁÉÍÓÚa-zñáéíóúü ]+";
	public static final String PATRON_APELLIDOS = "^[A-ZÑÁÉÍÓÚ][A-ZÑÁÉÍÓÚa-zñáéíóúü ]*";
	public static final String PATRON_TOPONIMO = "^[A-ZÑÁÉÍÓÚ][áéíóúña-z \\w]+";
